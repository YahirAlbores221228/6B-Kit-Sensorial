...
function Report() {
    return (
        <>
            <div className=" grid grid-cols-2 w-full h-auto p-10  pr-20 place-items-center">
                <form action="" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none" />
                        ...
                        <textarea name="" placeholder="Hello Word" id="" className="w-96 h-20 p-2  rounded-md border-2 border-gray-400  focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                ...
                <div >
                    <div className="grid gap-10" data-aos="fade-down"
                        ...
                        <div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias aperiam expedita atque praesentium officiis? Illum animi voluptas temporibus cum iusto repudiandae quibusdam facilis.</p>
                        </div>
                        <div>
                            <p className="mb-5">If you prefer more questions or suggestions, call:</p>
                            <h1 className="font-medium text-lg">+ 123 6897 8974</h1>
                        </div>
                        <div>
                            <h1 className="font-bold text-3xl mb-5">Opening hours:</h1>
                            <p className="font-medium text-lg">8 a.m. to 4 p.m.</p>
                        </div>
                    </div>
                </div>
            </div>
